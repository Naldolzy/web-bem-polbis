        ...
        <form method="POST" action="{{ route('admin.users.update', $user) }}" class="space-y-5">
            ...
            <div>
                ...
                <select name="role" class="form-input">
                    <option value="admin" {{ $user->role === 'admin' ? 'selected' : '' }} style="background:#0f1c3f;">Admin</option>
                    <option value="superadmin" {{ $user->role === 'superadmin' ? 'selected' : '' }} style="background:#0f1c3f;">Super Admin</option>
                </select>
