...
@section('content')
    ...
    <div class="page-header">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <p class="text-blue-400 mt-3 max-w-xl">Temukan kami di berbagai platform dan saluran komunikasi berikut.</p>
        </div>
    </div>
    ...
    <section class="py-20">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-12">
                ...
                @if(!empty($profil['email']))
                    <a href="mailto:{{ $profil['email'] }}"
                        class="bg-white shadow-sm hover:shadow-md border border-slate-200 p-6 rounded-3xl flex flex-col items-center text-center gap-3 group transition-all duration-300 hover:-translate-y-1">
                        <div
                            class="w-14 h-14 rounded-2xl bg-lime-500/15 border border-lime-500/25 flex items-center justify-center group-hover:bg-lime-500/25 transition-all">
                        ...
                        <div>
                            <div class="text-lime-700 font-bold text-sm mb-1">Email</div>
                            <div class="text-slate-600 text-sm break-all">{{ $profil['email'] }}</div>
                        </div>
                    </a>
                @endif
                ...
                @if(!empty($profil['telepon']))
                    <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $profil['telepon']) }}" target="_blank"
                        ...
                        <div>
                            <div class="text-green-700 font-bold text-sm mb-1">WhatsApp</div>
                            <div class="text-slate-600 text-sm">{{ $profil['telepon'] }}</div>
                        </div>
                    </a>
                @endif
                ...
                @if(!empty($profil['instagram']))
                    <a href="{{ $profil['instagram'] }}" target="_blank"
                        ...
                        <div>
                            <div class="text-pink-600 font-bold text-sm mb-1">Instagram</div>
                            <div class="text-slate-600 text-sm">@bem_polbis</div>
                        </div>
                    </a>
                @endif
                ...
                @if(!empty($profil['youtube']))
                    <a href="{{ $profil['youtube'] }}" target="_blank"
                        ...
                        <div>
                            <div class="text-red-700 font-bold text-sm mb-1">YouTube</div>
                            <div class="text-slate-600 text-sm">BEM Polbis</div>
                        </div>
                    </a>
                @endif
                ...
                @if(!empty($profil['tiktok']))
                    <a href="{{ $profil['tiktok'] }}" target="_blank"
                        class="bg-white shadow-sm hover:shadow-md border border-slate-200 p-6 rounded-3xl flex flex-col items-center text-center gap-3 group transition-all duration-300 hover:-translate-y-1">
                        <div
                            class="w-14 h-14 rounded-2xl bg-blue-400/15 border border-blue-400/25 flex items-center justify-center group-hover:bg-blue-400/25 transition-all">
                        ...
                        <div>
                            <div class="text-blue-700 font-bold text-sm mb-1">TikTok</div>
                            <div class="text-slate-600 text-sm">BEM Polbis</div>
                        </div>
                    </a>
                @endif
                ...
                <a href="https://share.google/IyB4fSntEhQkRyFmQ" target="_blank" rel="noopener"
                    ...
                    <div>
                        <div class="text-blue-700 font-bold text-sm mb-1 flex items-center justify-center gap-1">
                            Alamat
                        ...
                        <div class="text-blue-500 text-xs mt-1 font-medium">Buka di Google Maps →</div>
                    </div>
                </a>
            ...
            <div class="text-center">
                <p class="text-blue-500 text-sm">Informasi kontak dapat diperbarui melalui panel admin BEM.</p>
            </div> -->
